...
public:
	...
	void attachLeftSubtree(BinaryNodeTree<ItemType>* lefTreePtr) const throw(PrecondViolatedExcep);
	void attachRightSubtree(BinaryNodeTree<ItemType>* rightTreePtr) const throw(PrecondViolatedExcep);
...
//Funciona se corrigio
template < class ItemType>
void BinaryNodeTree<ItemType>::attachRightSubtree(BinaryNodeTree<ItemType>* rightTreePtr) const throw(PrecondViolatedExcep)
{
	if (isEmpty())
		throw PrecondViolatedExcep("TreeException: Empty tree");
	else {
